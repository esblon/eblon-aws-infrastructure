...
# Images applicatives immuables : commit 6abad53
...
$runtimeTag        = "6abad53-runtime-amd64"
$migrationTag      = "6abad53-migration-amd64"
...
$ssmRequest = @{
  ...
  Comment = "Deploy EBLON Bibliotheque UAT 6abad53"
  TimeoutSeconds = 600
  Parameters = @{
    commands = $commands
