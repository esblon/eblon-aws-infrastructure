...
# Images applicatives immuables : commit 6f3138d0db6a
...
$runtimeTag        = "6f3138d0db6a-runtime-amd64"
$migrationTag      = "6f3138d0db6a-migration-amd64"
...
$ssmRequest = @{
  ...
  Comment = "Deploy EBLON Bibliotheque UAT 6f3138d0db6a"
  TimeoutSeconds = 600
  Parameters = @{
    commands = $commands
