...
# Images applicatives immuables : commit 7045f3e
...
$runtimeTag        = "7045f3e-runtime-amd64"
$migrationTag      = "7045f3e-migration-amd64"
...
$ssmRequest = @{
  ...
  Comment = "Deploy EBLON Bibliotheque UAT 7045f3e"
  TimeoutSeconds = 600
  Parameters = @{
    commands = $commands
