...
# Images applicatives immuables : commit b628584
...
$runtimeTag        = "b628584-v2-runtime-amd64"
$migrationTag      = "b628584-v2-migration-amd64"
...
$ssmRequest = @{
  ...
  Comment = "Deploy EBLON Bibliotheque UAT b628584"
  TimeoutSeconds = 600
  Parameters = @{
    commands = $commands
